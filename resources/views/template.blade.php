...
<body>
    ...
    <div class="header_section header_bg">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="logo"><a href="{{ url('/') }}"><img src="/site/images/logo.png"></a></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="location_text"><img src="/site/images/map-icon.png"><span class="padding_left_15">Locations</span></div>
                    <div class="location_text"><img src="/site/images/call-icon.png"><span class="padding_left_15">+01 9876543210</span></div>
                    <div class="location_text"><img src="/site/images/mail-icon.png"><span class="padding_left_15">demo@gmail.com</span></div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <h4 class="about_text">About Financial</h4>
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="footer_images">
                        <div class="footer_images_left">
                            <div class="image_12"><img src="/site/images/img-12.png"></div>
                            <div class="image_12"><img src="/site/images/img-12.png"></div>
                            <div class="image_12"><img src="/site/images/img-12.png"></div>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="footer_social_icon">
                        <ul>
                            <li><a href="#"><img src="/site/images/fb-icon1.png"></a></li>
                            <li><a href="#"><img src="/site/images/twitter-icon1.png"></a></li>
                            <li><a href="#"><img src="/site/images/linkedin-icon1.png"></a></li>
                            <li><a href="#"><img src="/site/images/youtub-icon1.png"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
